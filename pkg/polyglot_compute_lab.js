...
function __wasm_bindgen_func_elem_515(arg0, arg1, arg2, arg3) {
    wasm.__wasm_bindgen_func_elem_515(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
 ...
 * @returns {number}
 */
export function run_rust_bump(iterations) {
    const ret = wasm.run_rust_bump(iterations);
    return ret;
}
 ...
 * @returns {number}
 */
export function run_rust_dll(iterations) {
    const ret = wasm.run_rust_dll(iterations);
    return ret;
}
 ...
 * @returns {number}
 */
export function run_rust_unsafe(iterations) {
    const ret = wasm.run_rust_unsafe(iterations);
    return ret;
}
 ...
 */
export function run_wgpu_dll(iterations) {
    const ret = wasm.run_wgpu_dll(iterations);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_new_ff12d2b041fb48f1 = function(arg0, arg1) {
        try {
            ...
            var cb0 = (arg0, arg1) => {
                ...
                state0.a = 0;
                try {
                    return __wasm_bindgen_func_elem_515(a, state0.b, arg0, arg1);
                } finally {
                    state0.a = a;
                }
            };
    ...
    imports.wbg.__wbindgen_cast_9670ba675826c9fc = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 34, function: Function { arguments: [NamedExternref("GPUUncapturedErrorEvent")], shim_idx: 35, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_953, __wasm_bindgen_func_elem_954);
        return addHeapObject(ret);
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('polyglot_compute_lab_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
